...
add_action(
	...
	function () {
		...
		acf_add_local_field(
			myshop_f( 'acct_greeting_title', __( 'Greeting — title', 'base-theme' ), 'text', array(
		...
		acf_add_local_field(
			myshop_f( 'acct_greeting_text', __( 'Greeting — text', 'base-theme' ), 'textarea', array(
				'rows'          => 2,
		...
		acf_add_local_field(
			myshop_f( 'acct_orders_enabled', __( 'Show "Latest Acquisitions" card', 'base-theme' ), 'true_false', array(
				'ui'            => 1,
				'default_value' => 1,
			) )
		);
		...
		acf_add_local_field(
			myshop_f( 'acct_orders_title', __( 'Title', 'base-theme' ), 'text', array(
		...
		acf_add_local_field(
			myshop_f( 'acct_orders_text', __( 'Text — has orders', 'base-theme' ), 'text', array(
		...
		acf_add_local_field(
			myshop_f( 'acct_orders_empty_text', __( 'Text — no orders yet', 'base-theme' ), 'text', array(
		...
		acf_add_local_field(
			myshop_f( 'acct_orders_btn', __( 'Button — has orders', 'base-theme' ), 'text', array_merge( $half, array(
		...
		acf_add_local_field(
			myshop_f( 'acct_orders_empty_btn', __( 'Button — no orders yet', 'base-theme' ), 'text', array_merge( $half, array(
		...
		acf_add_local_field(
			myshop_f( 'acct_security_enabled', __( 'Show "Privacy & Security" card', 'base-theme' ), 'true_false', array(
				'ui'            => 1,
				'default_value' => 1,
			) )
		);
		...
		acf_add_local_field(
			myshop_f( 'acct_security_title', __( 'Title', 'base-theme' ), 'text', array_merge( $half, array(
		...
		acf_add_local_field(
			myshop_f( 'acct_security_btn', __( 'Button label', 'base-theme' ), 'text', array_merge( $half, array(
		...
		acf_add_local_field(
			myshop_f( 'acct_security_text', __( 'Text', 'base-theme' ), 'text', array(
		...
		acf_add_local_field(
			myshop_f( 'acct_shipping_enabled', __( 'Show "Default Shipping" card', 'base-theme' ), 'true_false', array(
				'ui'            => 1,
				'default_value' => 1,
			) )
		);
		...
		acf_add_local_field(
			myshop_f( 'acct_shipping_title', __( 'Title', 'base-theme' ), 'text', array(
		...
		acf_add_local_field(
			myshop_f( 'acct_shipping_empty_text', __( 'Text — no address saved', 'base-theme' ), 'text', array(
		...
		acf_add_local_field(
			myshop_f( 'acct_shipping_btn', __( 'Button — has address', 'base-theme' ), 'text', array_merge( $half, array(
		...
		acf_add_local_field(
			myshop_f( 'acct_shipping_empty_btn', __( 'Button — no address', 'base-theme' ), 'text', array_merge( $half, array(
		...
		acf_add_local_field(
			myshop_f( 'acct_membership_enabled', __( 'Show "Membership" card', 'base-theme' ), 'true_false', array(
				'ui'            => 1,
				'default_value' => 1,
			) )
		);
		...
		acf_add_local_field(
			myshop_f( 'acct_membership_eyebrow', __( 'Eyebrow', 'base-theme' ), 'text', array_merge( $half, array(
		...
		acf_add_local_field(
			myshop_f( 'acct_membership_title', __( 'Title', 'base-theme' ), 'text', array_merge( $half, array(
		...
		acf_add_local_field(
			myshop_f( 'acct_membership_text', __( 'Text — perks set', 'base-theme' ), 'text', array(
		...
		acf_add_local_field(
			myshop_f( 'acct_membership_empty_text', __( 'Text — no perks set', 'base-theme' ), 'text', array(
		...
		acf_add_local_field(
			myshop_f( 'acct_membership_btn', __( 'Button label', 'base-theme' ), 'text', array(
		...
		acf_add_local_field(
			myshop_f( 'acct_curated_enabled', __( 'Show "Curated for you" section', 'base-theme' ), 'true_false', array(
				'ui'            => 1,
				'default_value' => 1,
		...
		acf_add_local_field(
			myshop_f( 'acct_curated_title', __( 'Title', 'base-theme' ), 'text', array_merge( $half, array(
		...
		acf_add_local_field(
			myshop_f( 'acct_curated_btn', __( 'Button label', 'base-theme' ), 'text', array_merge( $half, array(
		...
		acf_add_local_field(
			myshop_f( 'acct_curated_subtitle', __( 'Subtitle', 'base-theme' ), 'text', array(
